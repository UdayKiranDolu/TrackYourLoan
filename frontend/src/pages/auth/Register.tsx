    ...
    return (
        <div className="relative min-h-screen flex flex-col lg:flex-row text-white font-sans">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row w-full min-h-screen">
                ...
                {/* LEFT SIDE - BRANDING */}
                <div className="lg:w-1/2 w-full flex items-center justify-center p-10 text-center">

                    <div className="max-w-md">

                        {/* LOGO */}
                        <div className="flex items-center justify-center gap-3 mb-8">
                            <div className="w-14 h-14 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center font-bold text-xl">
                                TL
                            </div>
                            <span className="text-xl font-semibold">TrackYourLoan</span>
                        </div>
                        ...
                        <p className="text-lg text-white/80">
                            “Every smart financial journey begins with clarity and control.”
                        </p>
                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center px-6 py-12">
                    ...
                    <div className={`w-full max-w-lg bg-white/15 backdrop-blur-2xl border border-white/20 rounded-3xl p-10 lg:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.6)] transition-all hover:scale-[1.01] ${shake ? 'animate-shake' : ''}`}>
                        ...
                        <p className="text-center text-white/60 mb-8">
                            Join us and take control of your loans
                        </p>

                        {/* ERROR */}
                        {error && (
                            <div className="mb-4 p-4 bg-red-500/20 border border-red-400 rounded-xl flex items-center gap-3">
                                <FiAlertCircle />
                        ...
                        <p className="text-center text-sm mt-8 text-white/70">
                            ...
                            <Link to="/login" className="text-blue-700  font-extrabold underline">
                                Sign in
                            </Link>
                        </p>
